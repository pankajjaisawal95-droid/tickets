...
/* PATCH /admin/organizers/:id/kyc  { kyc_status } — approve/reject an organiser */
export const setOrganizerKyc = async (req, res) => {
  try {
    return success(res, await setOrganizerKycStatusService(req.params.id, req.body.kyc_status), "Organizer KYC updated");
  } catch (err) { return error(res, err.message, 400); }
};
